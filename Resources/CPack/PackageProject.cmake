...
SET(CPACK_PACKAGE_VENDOR "BlueQuartz Software, Purdue University")
...
#set(CPACK_COMPONENT_APPLICATIONS_DESCRIPTION  "The OpenMBIR Software Tools Suite")
...
set(CPACK_PACKAGE_EXECUTABLES
    BrightFieldGui BrightFieldGui MRCSubset MRCSubset MbirReconstruction MbirReconstruction)
...
elseif(WIN32)
    ...
    if( "${CMAKE_SIZEOF_VOID_P}" EQUAL "8" )
            set(CPACK_PACKAGE_FILE_NAME "OpenMBIR-${OpenMBIR_VERSION_SHORT}-${OpenMBIR_LINUX_SYSTEM}-x86_64")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.tar.gz)
    elseif( "${CMAKE_SIZEOF_VOID_P}" EQUAL "4" )
            set(CPACK_PACKAGE_FILE_NAME "OpenMBIR-${OpenMBIR_VERSION_SHORT}-${OpenMBIR_LINUX_SYSTEM}-i386")
            set(UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.tar.gz)
    else()
