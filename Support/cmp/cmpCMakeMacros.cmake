...
function(cmpVersionStringsFromGit)
    ...
    if(GIT_FOUND)
        ...
        WORKING_DIRECTORY ${OpenMBIR_SOURCE_DIR}
    )
...
function(COMPILE_TOOL)
    ...
    BuildToolBundle(
        ...
        VERSION_MAJOR ${D3DTOOL_OpenMBIR_VER_MAJOR}
        VERSION_MINOR ${D3DTOOL_OpenMBIR_VER_MINOR}
        VERSION_PATCH ${D3DTOOL_OpenMBIR_VER_PATCH}
